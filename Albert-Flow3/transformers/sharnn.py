...
class Block(nn.Module):
    def __init__(self, embed_dim, hidden_dim, heads=1, dropout=0.0, rnn=True, residual=True, use_attn=True):
        super().__init__()
    ...
    def forward(self, h, attn_mask, mem=None, hidden=None):
...
class SHARNN(nn.Module):
    def __init__(self, ninp, nhid, nlayers, dropout=0.5, dropouth=0.5, dropouti=0.5, dropoute=0.1, wdrop=0, tie_weights=False):
        super().__init__()
        # embed_dim = ninp
        self.input_dim = ninp
