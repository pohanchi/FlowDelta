            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if args.local_rank == -1 and args.evaluate_during_training:  # Only evaluate when single GPU otherwise metrics may not average well
                        ...
                        tb_writer.add_scalar('eval_F1',score,global_step)  
...
def evaluate(args, model, tokenizer, evaluator,prefix=""):
    eval_examples,eval_features = load_and_cache_examples(args, tokenizer, evaluate=True, output_examples=True)
...
def main():
    ...
    parser.add_argument('--output_file',type=str,default="f1_score.txt")
    ...
    # Training
    if args.do_train:
        _,features = load_and_cache_examples(args, tokenizer, evaluate=False, output_examples=False)
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        json.dump(vars(args),open("argparser_command.json",'w'))
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            # Evaluate
            score=evaluate(args, model, tokenizer, target_dict,prefix=global_step)
